            ...
            <div class="search-input_out_nav">
                <div class=" search-input_in">
                    ...
                    <form action="/idol-list" class="formSearchHeader">
                        ...
                        <img src="/assets/{{env('THEME_VERSION')}}/image/icon_search.png" class="icon-search-close" alt="">
    ...
    <div class="top-navigation d-none d-lg-block">
        <div class="container">
            <ul>
                <li>
                    <a href="">
                        <img src="/assets/{{env('THEME_VERSION')}}/image/top-navigation1.png" alt="">
                        <span>
                                Ứng dụng di động
                            </span>
                    </a>
                ...
                <li>
                    <a href="">
                        <img src="/assets/{{env('THEME_VERSION')}}/image/top-navigation2.png" alt="">
                        <span>
                                Tin tức
                ...
                <li>
                    <a href="">
                        <img src="/assets/{{env('THEME_VERSION')}}/image/top-navigation3.png" alt="">
                        <span>
                                Facebook Group
                            </span>
                    </a>
                ...
                <li>
                    <a href="">
                        <img src="/assets/{{env('THEME_VERSION')}}/image/top-navigation4.png" alt="">
                        <span>
                                Facebook fanpage
                            </span>
                    </a>
                ...
                <li>
                    <a href="">
                        <img src="/assets/{{env('THEME_VERSION')}}/image/top-navigation5.png" alt="">
                        <span>
                                Zalo: 1234 5678
                            </span>
                    </a>
                ...
                <li>
                    <a href="">
                        <img src="/assets/{{env('THEME_VERSION')}}/image/top-navigation6.png" alt="">
                        <span>
                                CSKH: 1234 5678
                            </span>
                    </a>
    ...
    <nav class="heading">
        <div class="header-container  container">
            <div class="open-hamburger-sidebar">
                <img src="/assets/{{env('THEME_VERSION')}}/image/hamburger_nav.png" alt="">
            </div>
                    ...
                    <div class="group-input">
                        ...
                        <div class="input-group-btn">
                            <button type="submit" class="btn px-3 border-0 shadow-none outline-none text-dark">
                                <img src="/assets/{{env('THEME_VERSION')}}/image/search.png" alt="">
                            </button>
                        </div>
                    </div>
                </form>
            ...
            <div class="box-about">
                <ul class="nav header-main-nav d-none d-lg-flex">
                    <li class="nav-item item-about active">
                        <a href="">
                            <img src="/assets/{{env('THEME_VERSION')}}/image/promotion.png" alt="">
                            <div class="item-about-title">Khuyến mãi</div>
                        </a>
                    </li>
                    <li class="nav-item item-about">
                        <a href="">
                            <img src="/assets/{{env('THEME_VERSION')}}/image/notification.png" alt="">
                            <div class="item-about-title">Thông báo</div>
                        </a>
                    </li>
                    <li class="nav-item item-about">
                        <a href="">
                            <img src="/assets/{{env('THEME_VERSION')}}/image/hot_event.png" alt="">
            ...
            <div class="box-about-mobile">
                <div class="nav header-main-nav  d-lg-flex">
                    <div class="nav-item-mobile item-search-mobile">
                        <a href="">
                            <img src="/assets/{{env('THEME_VERSION')}}/image/search_mobile.png" alt="">
                        </a>

                    </div>
                    <div class="nav-item-mobile item-notification-mobile">
                        <a href="">
                            <img src="/assets/{{env('THEME_VERSION')}}/image/notification_mobile.png" alt="">
                        </a>
            ...
            <div class="box-account d-none d-md-block">
                <div class="box-account-logined">
                    ...
                    <div class="account-triangle ">
                        <img src="/assets/{{env('THEME_VERSION')}}/image/triangle.png" alt="">
                    </div>
                        ...
                        <div class="account-menu-content">
                            <div class="account-menu_nav mb-fix-16">
                                <div class="account-menu_parent mb-fix-12">
                                    <img src="/assets/{{env('THEME_VERSION')}}/image/account_info.png" alt=""> Tài khoản

                                </div>
                                <div class="account-menu_child pt-fix-4 pb-fix-4">
                                    <a href="/profile">
                                        <div class="pr-fix-8"><img src="/assets/{{env('THEME_VERSION')}}/image/arrow-right.png" alt=""> </div> <span> Thông tin tài khoản</span>
                                    </a>

                                </div>
                                <div class="account-menu_child pt-fix-4 pb-fix-4">
                                    <a href="/change-password">
                                        <div class="pr-fix-8"><img src="/assets/{{env('THEME_VERSION')}}/image/arrow-right.png" alt=""> </div> <span> Đổi mật khẩu</span>
                                    </a>
                            ...
                            <div class="account-menu_nav mb-fix-16">
                                <div class="account-menu_parent mb-fix-12">
                                    <img src="/assets/{{env('THEME_VERSION')}}/image/account_trans.png" alt=""> Quản lý giao dịch
                                </div>
                                <div class="account-menu_child pt-fix-4 pb-fix-4">

                                    <a href="/rut-tien">
                                        <div class="pr-fix-8"><img src="/assets/{{env('THEME_VERSION')}}/image/arrow-right.png" alt=""> </div> <span> Rút tiền ATM - Ví điện tử</span>
                                    </a>
                                </div>
                                <div class="account-menu_child pt-fix-4 pb-fix-4">
                                    <a href="/rut-vat-pham">
                                        <div class="pr-fix-8"><img src="/assets/{{env('THEME_VERSION')}}/image/arrow-right.png" alt=""> </div> <span> Rút Vật phẩm</span>
                                    </a>
                            ...
                            <div class="account-menu_nav mb-fix-16">
                                <div class="account-menu_parent mb-fix-12">
                                    <img src="/assets/{{env('THEME_VERSION')}}/image/account_trans_history.png" alt=""> Lịch sử giao dịch
                                </div>
                                <div class="account-menu_child pt-fix-4 pb-fix-4">
                                    <a href="/lich-su-giao-dich">
                                        <div class="pr-fix-8"><img src="/assets/{{env('THEME_VERSION')}}/image/arrow-right.png" alt=""> </div> <span> Biến động số dư</span>
                                    </a>
                                </div>
                                <div class="account-menu_child pt-fix-4 pb-fix-4">
                                    <a href="/lich-su-nap-the">
                                        <div class="pr-fix-8"><img src="/assets/{{env('THEME_VERSION')}}/image/arrow-right.png" alt=""> </div> <span>Lịch sử nạp thẻ</span>
                                    </a>

                                </div>
                                <div class="account-menu_child pt-fix-4 pb-fix-4">
                                    <a href="/the-cao-da-mua">
                                        <div class="pr-fix-8"><img src="/assets/{{env('THEME_VERSION')}}/image/arrow-right.png" alt=""> </div> <span>Thẻ cào đã mua</span>
                                    </a>

                                </div>
                                <div class="account-menu_child pt-fix-4 pb-fix-4">
                                    <a href="/lich-su-dich-vu">
                                        <div class="pr-fix-8"><img src="/assets/{{env('THEME_VERSION')}}/image/arrow-right.png" alt=""> </div> <span>Dịch vụ đã mua</span>
                                    </a>

                                </div>
                                <div class="account-menu_child pt-fix-4 pb-fix-4">
                                    <a href="/lich-su-atm-tu-dong">
                                        <div class="pr-fix-8"><img src="/assets/{{env('THEME_VERSION')}}/image/arrow-right.png" alt=""> </div> <span>Lịch sử nạp ATM tự động</span>
                                    </a>

                                </div>
                                <div class="account-menu_child pt-fix-4 pb-fix-4">
                                    <a href="/lich-su-mua-nick">
                                        <div class="pr-fix-8"><img src="/assets/{{env('THEME_VERSION')}}/image/arrow-right.png" alt=""> </div> <span>Tài khoản đã mua</span>
                                    </a>

                                </div>
                                <div class="account-menu_child pt-fix-4 pb-fix-4">
                                    <a href="/lich-su-tra-gop">
                                        <div class="pr-fix-8"><img src="/assets/{{env('THEME_VERSION')}}/image/arrow-right.png" alt=""> </div> <span>Tài khoản trả góp</span>
                                    </a>
            ...
            <ul>
                <li>
                    <a href="/nap-the">
                        ...
                        <span id="nav-charge" class="{{ Request::is('nap-the') ? 'nav-profile-active' : '' }}">Nạp thẻ cào</span>
                    </a>
                </li>
                <li>
                ...
                <li>
                    <a href="/mua-the">
                        <img src="/assets/{{env('THEME_VERSION')}}/image/service1.png" alt="">
                        <span id="nav-store" class="{{ Request::is('mua-the') ? 'nav-profile-active' : '' }}">Mua thẻ Game</span>
                    </a>
                </li>
                <li>
                    <a href="/mua-acc">
                        <img src="/assets/{{env('THEME_VERSION')}}/image/service1.png" alt="">
                        <span id="nav-buy__acc" class="{{ Request::is('mua-acc') ? 'nav-profile-active' : '' }}">Mua Acc Game</span>
                    </a>
                </li>
                <li>
                    <a href="/dich-vu">
                        <img src="/assets/{{env('THEME_VERSION')}}/image/service1.png" alt="">
                        <span id="nav-service" class="{{ Request::is('dich-vu') ? 'nav-profile-active' : '' }}">Dịch vụ Game</span>
                    </a>
                </li>
                <li>
                    <a href="/recharge-game">
                        <img src="/assets/{{env('THEME_VERSION')}}/image/service1.png" alt="">
                        <span id="nav-recharge_game" class="{{ Request::is('recharge-game') ? 'nav-profile-active' : '' }}">Nạp game</span>
                    </a>
                </li>
                <li>
                    <a href="/minigame">
                        <img src="/assets/{{env('THEME_VERSION')}}/image/service1.png" alt="">
                        <span id="nav-minigame" class="{{ Request::is('minigame') ? 'nav-profile-active' : '' }}">Vòng quay</span>
                    </a>
                </li>
