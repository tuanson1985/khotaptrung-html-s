...
@section('content')
<div class="banner-home " style=" background: url(/assets/{{env('THEME_VERSION')}}/image/banner.png) no-repeat center center / cover;">
    <div class="container container-fix">
        <div class="d-flex justify-content-between">
            ...
            <div class="box-list-top top-list d-g-lg-none">
                <p><img src="/assets/{{env('THEME_VERSION')}}/image/star_top.png" alt=""> Top nạp thẻ</p>
...
<div class="container container-fix">
    ...
    <div class="block-product mt-fix-20 d-g-md-none">
        <div class="product-header d-flex">
            ...
            <div class="text-view-more">
{{--                <a href="">--}}
{{--                    Xem thêm <img src="/assets/{{env('THEME_VERSION')}}/image/view_more.png" alt="">--}}
{{--                </a>--}}
                <a href="/dich-vu" class="global__link">Xem thêm<i class="__icon --sm --link ml-1" style="--path : url(/assets/theme_3/image/icons/arrow-right-blue.png)"></i></a>
            </div>
        </div>
...
{{--                        </div>--}}
    ...
    <div class="block-product mt-fix-20">
        <div class="product-header d-flex">
                    <span>
                        <img src="/assets/{{env('THEME_VERSION')}}/image/nick_title.png" alt="">
                    </span>
        ...
        <div class="box-product">
            <div class=" list-product d-flex flex-wrap" >
                <div class="item-product item-nick ">
                    <a href="/mua-acc/slug">
                        <div class="item-nick-img">
                            <img src="/assets/{{env('THEME_VERSION')}}/image/nick_game1.png" alt="">
                        </div>
                ...
                <div class="item-product  item-nick">
                    <a href="/mua-acc/slug">
                        <div class="item-nick-img">
                            <img src="/assets/{{env('THEME_VERSION')}}/image/nick_game2.png" alt="">
                        </div>
                ...
                <div class="item-product  item-nick">
                    <a href="">
                        <div class="item-nick-img">
                            <img src="/assets/{{env('THEME_VERSION')}}/image/nick_game3.png" alt="">
                        </div>
                ...
                <div class="item-product  item-nick">
                    <a href="/mua-acc/slug">
                        <div class="item-nick-img">
                            <img src="/assets/{{env('THEME_VERSION')}}/image/nick_game4.png" alt="">
                        </div>
                ...
                <div class="item-product  item-nick">
                    <a href="/mua-acc/slug">
                        <div class="item-nick-img">
                            <img src="/assets/{{env('THEME_VERSION')}}/image/nick_game5.png" alt="">
                        </div>
                ...
                <div class="item-product  item-nick">
                    <a href="/mua-acc/slug">
                        <div class="item-nick-img">
                            <img src="/assets/{{env('THEME_VERSION')}}/image/nick_game6.png" alt="">
                        </div>
                ...
                <div class="item-product  item-nick">
                    <a href="/mua-acc/slug">
                        <div class="item-nick-img">
                            <img src="/assets/{{env('THEME_VERSION')}}/image/nick_game7.png" alt="">
                        </div>
                ...
                <div class="item-product  item-nick">
                    <a href="/mua-acc/slug">
                        <div class="item-nick-img">
                            <img src="/assets/{{env('THEME_VERSION')}}/image/nick_game8.png" alt="">
                        </div>
        ...
        <div class="row mr-fix-10 ml-fix-10">
            <div class="col-12 col-md-6 col-lg-3 pr-fix-10 pl-fix-10 ">
                <div class="block-product mb-md-fix-12">
                    <div class="product-header d-flex">
                                <span>
                                    <img src="/assets/{{env('THEME_VERSION')}}/image/nick_dif.png" alt="">
                                </span>
                        ...
                        <div class="swiper-container list-product list-other-nick mt-fix-12 d-none d-g-md-block"   >
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide" >
                                    <div class="item-product__box-img">
                                        <a href="/acc/id">
                                            <img src="/assets/{{env('THEME_VERSION')}}/image/product6.gif" alt="">
                                        </a>
                                    </div>
                                    <div class="item-product__box-content">
