...
{{--    <link rel="stylesheet" href="/assets/frontend/{{env('THEME_VERSION')}}/css/historydetail.css">--}}
    <script src="/assets/frontend/{{env('THEME_VERSION')}}/js/service/service-history-detail.js"></script>
@endsection
