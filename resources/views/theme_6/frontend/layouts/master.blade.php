...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/assets/frontend/{{env('THEME_VERSION')}}/css/slick.css"/>
    <link rel="stylesheet" type="text/css" href="/assets/frontend/{{env('THEME_VERSION')}}/css/slick-theme.css"/>

    <link rel="stylesheet" type="text/css" href="/assets/frontend/{{env('THEME_VERSION')}}/css/account.css"/>
    ...
    <link href="/assets/frontend/{{env('THEME_VERSION')}}/js/toastr.min.css" rel="stylesheet" type="text/css"/>
    <script src="/assets/frontend/{{env('THEME_VERSION')}}/js/toastr.min.js"></script>
...
<div class="search-input_out">
    ...
    <div class="search-input_in_content ">
        ...
        <div class="search-input_in_content-detail-load-more" style="display: none">
            <p>Xem thêm  <span><img src="/assets/frontend/{{env('THEME_VERSION')}}/image/xuocdoi_xuong.svg" alt=""></span></p>
        </div>
    </div>
</div>
                    ...
                    <div class="modal-bottom" style="margin-top: 15px">
                        <p class="text-center">
                            <a href="http://fb.nhapnick.com/napgamegiare_net"class="btn  btn-social btn-facebook btn-flat d-inline-block" style="margin-bottom:5px"><img
                                    src="/assets/frontend/{{env('THEME_VERSION')}}/image/facebook-icon.png" alt="" width="32px" height="32px"></a>
                        </p>
                        <p class="text-center">
