...
@section('content')
    <div class="container container-fix" style="max-width: 1232px">
        ...
        <div class=" --custom p-3 mb-3 content-detail ">
            <article id="article--detail">
                ...
                <div class="article--info">
                    <img src="/assets/frontend/{{env('THEME_VERSION')}}/image/duong/time.svg"
                         class="c-mr-6"><span>21/01/2022</span>
                    <img src="/assets/frontend/{{env('THEME_VERSION')}}/image/duong/group.svg"
                         class="c-mr-6 c-ml-6"><span>An Nguyen</span>
                </div>
                <div class="article--thumbnail py-4"></div>
                <div class="article--content pb-3">
                    <div class="article--content__text pb-2">
                        ...
                        <br>
                        <br>
                        <img src="/assets/frontend/{{env('THEME_VERSION')}}/image/duong/image-article-detail.jpg" alt="" style="width: 100%">
                        <br>
                        <br>
                        <h5>1. CHUYỂN MÃ VÙNG VIỆT NAM</h5>
                        <br>
                        <br>
        ...
        {{--        Cùng chủ đề--}}
        <div class="c-pb-24">
            @include('theme_7.frontend.widget.__related__articles')
        </div>
