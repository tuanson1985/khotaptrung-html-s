        ...
        <div class="swiper-wrapper">
            <div class="swiper-slide">
                <div class="item-category">
                    <div class="card">
                        <a href="/acc/id" class="card-body scale-thumb c-p-0">
                            <div class="account-thumb block-thumb flag-discount" data-content="90%">
                                <img src="/assets/frontend/{{env('THEME_VERSION')}}/image/duong/image_2.png" alt="" class="account-thumb-image">
                            </div>
                            <div class="c-p-16">
