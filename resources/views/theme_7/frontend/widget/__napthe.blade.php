<h2 class="section-title c-mb-16 c-mb-lg-8">
    <i class="icon-title c-mr-8" style="--path:url(/assets/frontend/theme_5/image/son/naptien.svg)"></i>
    Nạp tiền
</h2>
<div class="row c-mb-24 c-mb-lg-24">
                    ...
                    <form action="">
                        <div class="row">
                            <div class="col-12 col-md-6 c-pr-8">
                                ...
                                <div class="col-12 p-0 c-mt-12 c-mt-lg-32 d-flex d-md-none">
