<section class="section-related-service c-mb-24 media-web">
    <div class="section-header c-mb-8 c-mb-lg-16 justify-content-between">
        <h2 class="section-title fz-lg-15 lh-lg-24">
            <i class="icon-title c-mr-8" style="--path:url(/assets/frontend/theme_5/image/svg/acc-game.svg)"></i>
            Nick ngon giá rẻ
        </h2>
                    ...
                    <div class="card-body c-p-16 c-p-lg-12 scale-thumb">
                        <a href="/acc/id">
                            <div class="card-thumb c-mb-8">
                                <img src="/assets/frontend/theme_5/image/son/ngon01.png" alt="" class="card-thumb-image">
                            </div>
                            <div class="card-attr">
            ...
            <div class="swiper-slide">
                <div class="card">
                    <div class="card-body c-p-16 c-p-lg-12 scale-thumb">
                        <a href="/acc/id">
                            <div class="card-thumb c-mb-8">
                                <img src="/assets/frontend/theme_5/image/son/ngon02.png" alt="" class="card-thumb-image">
                            </div>
                            <div class="card-attr">
                                <div class="text-title fw-700">
                                    Ngọc rồng online
            ...
            <div class="swiper-slide">
                <div class="card">
                    <div class="card-body c-p-16 c-p-lg-12 scale-thumb">
                        <a href="/acc/id">
                            <div class="card-thumb c-mb-8">
                                <img src="/assets/frontend/theme_5/image/son/ngon03.png" alt="" class="card-thumb-image">
                            </div>
                            <div class="card-attr">
                                <div class="text-title fw-700">
                                    Liên minh tốc chiến
            ...
            <div class="swiper-slide">
                <div class="card">
                    <div class="card-body c-p-16 c-p-lg-12 scale-thumb">
                        <a href="/acc/id">
                            <div class="card-thumb c-mb-8">
                                <img src="/assets/frontend/theme_5/image/son/ngon04.png" alt="" class="card-thumb-image">
                            </div>
                            <div class="card-attr">
                                <div class="text-title fw-700">
                                    ROBLOX
            ...
            <div class="swiper-slide">
                <div class="card">
                    <div class="card-body c-p-16 c-p-lg-12 scale-thumb">
                        <a href="/acc/id">
                            <div class="card-thumb c-mb-8">
                                <img src="/assets/frontend/theme_5/image/son/ngon05.png" alt="" class="card-thumb-image">
                            </div>
                            <div class="card-attr">
                                <div class="text-title fw-700">
                                    Độc kích
