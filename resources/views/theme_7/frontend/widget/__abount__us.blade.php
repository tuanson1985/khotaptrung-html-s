    ...
    <div class="box-product c-mt-md-18">
        <div class="swiper-container  list-intro">
            <div class="swiper-wrapper">
                <div class="swiper-slide item-about-us c-p-md-16 c-mr-16">
                    <div class="item-intro-img c-pt-16">
                        <img src="/assets/frontend/{{env('THEME_VERSION')}}/image/duong/intro1.svg" alt="">
                    </div>
                ...
                <div class="swiper-slide item-about-us c-p-md-16 c-mr-16">
                    <div class="item-intro-img c-pt-16">
                        <img src="/assets/frontend/{{env('THEME_VERSION')}}/image/duong/intro2.svg" alt="">
                    </div>
                    <div class="list-intro-title list-intro-title-mobile fz-18 fw-500">
                ...
                <div class="swiper-slide item-about-us c-p-md-16 c-mr-16">
                    <div class="item-intro-img c-pt-16">
                        <img src="/assets/frontend/{{env('THEME_VERSION')}}/image/duong/intro3.svg" alt=""></div>
                    <div class="list-intro-title list-intro-title-mobile fz-18 fw-500">
                ...
                <div class="swiper-slide item-about-us c-p-md-16 c-mr-16">
                    <div class="item-intro-img c-pt-16">
                        <img src="/assets/frontend/{{env('THEME_VERSION')}}/image/duong/intro4.svg" alt=""></div>
                    <div class="list-intro-title list-intro-title-mobile fz-18 fw-500">
