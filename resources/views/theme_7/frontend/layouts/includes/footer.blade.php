        ...
        <div class="row mobile-default-footer c-pl-lg-0 c-pr-lg-0">
            <div class="footer-default-body-row footer-default-col">
                <div class="col-md-12 c-pb-24 c-pt-22">
                    <img src="/assets/frontend/{{env('THEME_VERSION')}}/image/duong/logo_footer.svg" alt="">
                </div>
                ...
                <div class="col-md-12  left-right">
                    <ul style="list-style: none;padding-left: 0">
                        <li class="link-footer">
                            <a href="javascript:void(0)" class="global__link__footer"><img src="/assets/frontend/{{env('THEME_VERSION')}}/image/duong/phone.svg"><span class="c-pl-8">Hỗ trợ bán hàng: 1900 1111</span></a>
                        </li>
                        <li class="link-footer">
                            <a href="javascript:void(0)" class="global__link__footer"><img src="/assets/frontend/{{env('THEME_VERSION')}}/image/duong/phone.svg"><span class="c-pl-8">Hợp tác phát triển: 1900 3333</span></a>
                        </li>
                        <li class="link-footer">
                            <a href="javascript:void(0)" class="global__link__footer"><img src="/assets/frontend/{{env('THEME_VERSION')}}/image/duong/zalo.svg"><span class="c-pl-8">Zalo: 021345678</span></a>
                        </li>
                        <li class="link-footer">
                            <a href="javascript:void(0)" class="global__link__footer"><img src="/assets/frontend/{{env('THEME_VERSION')}}/image/duong/telegram.svg"><span class="c-pl-8">Telegram: 1234567 2323</span></a>
                        </li>
                        <li class="link-footer">
                            <a href="javascript:void(0)" class="global__link__footer"><img src="/assets/frontend/{{env('THEME_VERSION')}}/image/duong/facebook.svg"><span class="c-pl-8">Facebook fanpage</span></a>
                        </li>
                        <li class="link-footer">
                            <a href="javascript:void(0)" class="global__link__footer"><img src="/assets/frontend/{{env('THEME_VERSION')}}/image/duong/tiktok.svg"><span class="c-pl-8"> Tiktok</span></a>
                        </li>
                        <li class="link-footer">
                            <a href="javascript:void(0)" class="global__link__footer"><img src="/assets/frontend/{{env('THEME_VERSION')}}/image/duong/youtube.svg"><span class="c-pl-8"> Youtube</span></a>
                        </li>
                    </ul>
                </div>
            </div>
