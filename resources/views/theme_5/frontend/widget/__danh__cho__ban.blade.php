<section class="section-category-tab c-mb-20 c-mb-lg-16">
    ...
    <!-- Đặt tên class cho swiper sau đó config trong file "public/assets/frontend/theme_5/js/swiper-slider-conf/swiper-slider-conf.js" -->
                            ...
                            <div class="card">
                                <a href="" class="card-body scale-thumb c-p-16 c-p-lg-12">
                                    <div class="account-thumb c-mb-8">
                                        <img src="/assets/frontend/theme_5/image/son/nick01.png" alt="" class="account-thumb-image">
                                    </div>
                    ...
                    <div class="swiper-slide">
                        <div class="item-category">
                            <div class="card">
                                <a href="" class="card-body scale-thumb c-p-16 c-p-lg-12">
                                    <div class="account-thumb c-mb-8">
                                        <img src="/assets/frontend/theme_5/image/son/nick02.png" alt="" class="account-thumb-image">
                                    </div>
                                    <div class="account-title">
                                        <div class="text-title fw-700 text-limit limit-1">Nick Freefire random....</div>
                                    </div>
                    ...
                    <div class="swiper-slide">
                        <div class="item-category">
                            <div class="card">
                                <a href="" class="card-body scale-thumb c-p-16 c-p-lg-12">
                                    <div class="account-thumb c-mb-8">
                                        <img src="/assets/frontend/theme_5/image/son/nick03.png" alt="" class="account-thumb-image">
                                    </div>
                                    <div class="account-title">
                                        <div class="text-title fw-700 text-limit limit-1">Nick Freefire random....</div>
                                    </div>
                    ...
                    <div class="swiper-slide">
                        <div class="item-category">
                            <div class="card">
                                <a href="" class="card-body scale-thumb c-p-16 c-p-lg-12">
                                    <div class="account-thumb c-mb-8">
                                        <img src="/assets/frontend/theme_5/image/son/nick04.png" alt="" class="account-thumb-image">
                                    </div>
                                    <div class="account-title">
                                        <div class="text-title fw-700 text-limit limit-1">Nick Freefire random....</div>
                                    </div>
                    ...
                    <div class="swiper-slide">
                        <div class="item-category">
                            <div class="card">
                                <a href="" class="card-body scale-thumb c-p-16 c-p-lg-12">
                                    <div class="account-thumb c-mb-8">
                                        <img src="/assets/frontend/theme_5/image/son/nick05.png" alt="" class="account-thumb-image">
                                    </div>
                                    <div class="account-title">
                                        <div class="text-title fw-700 text-limit limit-1">Nick Freefire random....</div>
                                    </div>
                    ...
                    <div class="swiper-slide">
                        <div class="item-category">
                            <div class="card">
                                <a href="" class="card-body scale-thumb c-p-16 c-p-lg-12">
                                    <div class="account-thumb c-mb-8">
                                        <img src="/assets/frontend/theme_5/image/son/minigame01.png" alt="" class="account-thumb-image">
                                    </div>
                                    <div class="account-title">
                                        <div class="text-title fw-700 text-limit limit-1">Nick Freefire random....</div>
                                    </div>
                    ...
                    <div class="swiper-slide">
                        <div class="item-category">
                            <div class="card">
                                <a href="" class="card-body scale-thumb c-p-16 c-p-lg-12">
                                    <div class="account-thumb c-mb-8">
                                        <img src="/assets/frontend/theme_5/image/trong/framse19968.png" alt="" class="account-thumb-image">
                                    </div>
                                    <div class="account-title">
                                        <div class="text-title fw-700 text-limit limit-1">Nick Freefire random....</div>
                                    </div>
                    ...
                    <div class="swiper-slide">
                        <div class="item-category">
                            <div class="card">
                                <a href="" class="card-body scale-thumb c-p-16 c-p-lg-12">
                                    <div class="account-thumb c-mb-8">
                                        <img src="/assets/frontend/theme_5/image/trong/image 2.png" alt="" class="account-thumb-image">
                                    </div>
                                    <div class="account-title">
                                        <div class="text-title fw-700 text-limit limit-1">Nick Freefire random....</div>
                                    </div>
