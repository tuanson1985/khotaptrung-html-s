            ...
            <div class="swiper-wrapper">
                <div class="swiper-slide item-about-us c-p-md-16 c-mr-16">
                    <div class="item-intro-img c-pt-16">
                        <img src="{{asset('assets/frontend/theme_5/image/duong/intro1.svg')}}" alt="">
                    </div>
                ...
                <div class="swiper-slide item-about-us c-p-md-16 c-mr-16">
                    <div class="item-intro-img c-pt-16">
                        <img src="{{asset('assets/frontend/theme_5/image/duong/intro2.svg')}}" alt="">
                    </div>
                    <div class="list-intro-title list-intro-title-mobile fz-18 fw-500">
                ...
                <div class="swiper-slide item-about-us c-p-md-16 c-mr-16">
                    <div class="item-intro-img c-pt-16">
                        <img src="{{asset('assets/frontend/theme_5/image/duong/intro3.svg')}}" alt=""></div>
                    <div class="list-intro-title list-intro-title-mobile fz-18 fw-500">
                ...
                <div class="swiper-slide item-about-us c-p-md-16 c-mr-16">
                    <div class="item-intro-img c-pt-16">
                        <img src="{{asset('assets/frontend/theme_5/image/duong/intro4.svg')}}" alt=""></div>
                    <div class="list-intro-title list-intro-title-mobile fz-18 fw-500">
