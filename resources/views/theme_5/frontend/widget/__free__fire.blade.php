<section class="acc-game c-mb-24 c-mb-lg-28">
    <div class="section-header c-mb-24 c-mb-lg-16 justify-content-between">
        <h2 class="section-title fz-lg-15 lh-lg-24">
            <i class="icon-title c-mr-8" style="--path:url(/assets/frontend/theme_5/image/son/freefire.svg)"></i>
            Freefire
        </h2>
                    ...
                    <div class="card">
                        <a href="/acc/id" class="card-body scale-thumb c-p-16 c-p-lg-12">
                            <div class="account-thumb c-mb-8">
                                <img src="/assets/frontend/theme_5/image/son/freefile01.png" alt="" class="account-thumb-image">
                            </div>
