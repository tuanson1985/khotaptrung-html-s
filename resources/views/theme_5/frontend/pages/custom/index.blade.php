...
@section('content')
    ...
    <div class="container mx-auto mb-4">
        ...
        <div class="js-quantity">
            ...
            <input type="text" class="js-quantity-input">
        ...
        <div class="m-4"></div>
        <button class="btn pink sm">Primary</button>
        <button class="btn pink">Primary</button>
        <button class="btn pink xl">Primary Primary</button>
        <button class="btn pink xl" disabled>Primary Primary</button>
        <button class="btn pink" disabled>Primary disabled</button>
        <button class="btn pink sm" disabled>Primary disabled</button>
        <div class="m-4"></div>
        ...
        <button class="btn primary two-line">
            <span class="line-1">Mua ngay</span>
            <span class="line-2">Rẻ như chooo</span>
        </button>
        <hr>
        ...
        <a class="tab icon-custom" style="--path-icon:url('/assets/frontend/theme_5/image/nam/storecard.svg')">Tabs Icon Custom</a>
        ...
        <form action="" class="form-search mt-4 position-relative" style="width: 400px">
