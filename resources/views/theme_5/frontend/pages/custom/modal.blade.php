...
{{--                            <div class="text-error c-mt-4 w-100 text-left">Help message here.</div>--}}
                    ...
                    <div class="modal-login-overlay-container">
                        <div class="modal-login-overlay">
                            <div class="modal-login-overlay-panel modal-login-overlay-left" style="background-image: url('/assets/frontend/{{env('THEME_VERSION')}}/image/son/bglogin.png')">
                            ...
                            <div class="modal-login-overlay-panel modal-login-overlay-right" style="background-image: url('/assets/frontend/{{env('THEME_VERSION')}}/image/son/bglogin.png')">
                                <img class="close-login-modal" src="/assets/frontend/{{env('THEME_VERSION')}}/image/son/close.svg" alt="">
                                <p class="modal-login-suggestion fw-700 fz-24 fz-lg-20 fz-md-18 fz-sm-16 c-mt-24 c-mt-lg-20 c-mt-md-16 c-mt-sm-8 mb-0">Nick.vn xin chào</p>
                    ...
                    <div class="c-mt-4">
                        <div class="col-md-12 p-0 position-relative">
                            <label for="checkbox2" class="input-checkbox">
                                ...
                                <span class="checkmark"></span>
                                <span class="text-label c-cursor w-100">Bạn Đã Đọc Kĩ Quy Định Và Chuẩn Bị Đầy Đủ Vật Phẩm, Phụ Kiện Theo Yêu Cầu Của Shop Chưa?</span>
                            </label>
                        </div>
                    </div>
                </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-custom">
            <div class="modal-content">
                ...
                <div class="modal-body c-pl-24 c-pr-24 pt-0 pb-0">
                    ...
                    <div class="c-mt-12">
                        <a class="c-mb-4 fw-400 fz-13 lh-20 text-center" href="javascript:void(0)">Đã lấy mật khẩu lúc: 05-05-2022, 121:32:56</a>
                    </div>
                    <div class="c-mt-16">
