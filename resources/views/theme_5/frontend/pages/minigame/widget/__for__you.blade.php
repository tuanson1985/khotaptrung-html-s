<section class="section-category-tab for-you">
    <div class="section-header c-mb-24 c-mb-lg-16 justify-content-between">
        <h2 class="section-title fz-lg-18 c-pb-lg-8 c-pt-8 c-pt-lg-0">
            Dành cho bạn
        </h2>
                    ...
                    <div class="swiper-slide">
                        <div class="item-category">
                            <div class="card">
                                ...
                                <a href="/minigame-slug" class="btn secondary lg-sm c-mx-16 c-mb-16 c-mx-lg-12 c-mb-lg-12">Chơi ngay</a>
                            </div>
                        </div>
                    </div>
                    <div class="swiper-slide">
